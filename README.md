...
Данные на странице: форма с полями — название спектакля, название театра (только отображение, не редактируется), выпадающий список режиссёров, множественный выбор актёров, продолжительность, цена билета в партер, цена билета на балкон, цена билета в бельэтаж.
...
Данные на странице: форма с полями — имя персоны, роль.
